...
<body>
	...
	<div id="myCarousel" class="carousel slide">
		...
		<div class="carousel-inner">
            ...
            <div class="item active">
                    ...
                    <div class="item">
                        <img alt="Second slide" src="${APP_PATH}/statics/t10images/547567.jpg">
                    </div>
                    <div class="item">
                        <img alt="Third slide" src="${APP_PATH}/statics/t10images/547567.jpg">
                    </div>
                    <div class="item">
                        <img alt="Third slide" src="${APP_PATH}/statics/t10images/547567.jpg">
                    </div>
                   <a data-slide="prev" href="#myCarousel" class="carousel-control left">
                   	<i class="icon-left"><img src="${APP_PATH}/statics/t10images/54354.png"></i>
                   </a>
                   <a data-slide="next" href="#myCarousel" class="carousel-control right">
                   	<i class="icon-right"><img src="${APP_PATH}/statics/t10images/4525424.png"></i>
                   </a>
        </div>            
		</div>
	...
	<div class="main container">
            ...
            <div class="main-a row">
                    ...
                    <div class="row text-center">
                        <ul class="list-unstyled">
                            <li class="col-xs-12 up-1">
                                <img alt="" src="${APP_PATH}/statics/t10images/45354312.png">
                            </li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="row text-center">
                        <ul class="list-unstyled">
                            <li class="col-xs-12 up-1">
                                <img alt="" src="${APP_PATH}/statics/t10images/879789.png">
                            </li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="row text-center">
                        <ul class="list-unstyled">
                            <li class="col-xs-12 up-1">
                                <img alt="" src="${APP_PATH}/statics/t10images/786453654365.png">
                            </li>
        ...
        <div class="row main-bottom">
            ...
            <ul class="logo">
                <li>
                   <a href=""><img src="${APP_PATH}/statics/t10images/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${APP_PATH}/statics/t10images/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${APP_PATH}/statics/t10images/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${APP_PATH}/statics/t10images/1471.png"></a>
                </li>
                <li>
                    <a href="">  <img src="${APP_PATH}/statics/t10images/7861.png"></a>
                </li>
            </ul>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-2 col-lg-2 up-3">
                        <p>微信公众平台</p>
                        <img alt="" src="${APP_PATH}/statics/t10images/2524.jpg">
                    </div>
                </div>
            </div>
